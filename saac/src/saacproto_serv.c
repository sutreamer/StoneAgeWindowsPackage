...
int saacproto_ServerDispatchMessage( int fd , char *encoded, char *debugfun)
{
...
#ifdef _ALLDOMAN					// Syu ADD 锟斤拷锟叫帮拷NPC
...
#ifdef _PERSONAL_FAME	// Arminius: 锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟�
	...
	// 锟藉长锟斤拷顺锟皆憋拷锟斤拷锟斤拷锟藉、锟睫改硷拷锟斤拷锟皆敝拔�
	...
	if( strcmp( funcname , "ACCharLogin" ) == 0 ){
		...
		printf("이거 안되나? %d %s %s %s",clifd,id,pas,ip);
...
215 :      ACCharSave锟藉覆锟斤拷锟斤拷忒锟较ｏ拷
216 :      <br><br>
217 :      <dl>
218 :        <dt> string result
219 :        <dd>"successful" , "failed" 锟斤拷锟斤拷锟斤拷木锟斤拷锟斤拷
220 :        <dt> string data
221 :        <dd>"failed"锟斤拷锟捷凤拷    毛锟斤拷锟斤拷锟斤拷锟睫硷拷苇锟斤拷锟斤拷锟斤拷  侬  匹丐锟铰ｏ拷
222 :        <dt> int id
223 :        <dd> 娄锟窖硷拷id毛锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷苹锟竭�锟斤拷
224 :      </dl>
225 :      <br>
226 :      <br>
227 : 
...
257 :      ACCharDelete锟藉覆锟斤拷锟斤拷忒锟较ｏ拷
258 :      <br><br>
259 :      <dl>
260 :        <dt> string result
261 :        <dd>"successful" , "failed" 锟斤拷锟斤拷锟斤拷木锟斤拷锟斤拷
262 :        <dt> string data
263 :        <dd>"failed"锟斤拷锟捷凤拷    毛锟斤拷锟斤拷锟斤拷锟睫硷拷苇锟斤拷锟斤拷锟斤拷  侬  匹丐锟铰ｏ拷
264 :        <dt> int id
265 :        <dd> 娄锟窖硷拷id锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟�
266 : 			   
267 :      </dl>
268 :      <br>
269 :      <br>
...
291 :      ACLock锟藉覆锟斤拷锟斤拷忒锟较ｏ拷
292 :      <br><br>
293 :      <dl>
294 :        <dt>string result
295 :        <dd>"successful" , "failed" 锟斤拷锟斤拷锟斤拷木锟斤拷锟斤拷
296 :        <dt>string data
297 :        <dd>"failed"锟斤拷锟捷凤拷    毛锟斤拷锟斤拷锟斤拷锟睫硷拷苇锟斤拷锟斤拷锟斤拷  侬  匹丐锟铰ｏ拷
298 :        <dt>int id
299 :        <dd>娄锟窖硷拷id锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟�
300 :      </dl>
301 :      <br>
302 :      <br>
303 : 
...
319 : 	 失锟斤拷锟斤拷锟斤拷锟斤拷锟接★拷锟斤拷锟斤拷锟斤拷毡亍锟截╋拷印锟斤拷锟斤拷锟藉覆锟狡伙拷锟斤拷丐锟铰斤拷锟斤拷锟角★拷锟斤拷锟截伙拷锟斤拷锟斤拷碳锟�
320 : 	 锟狡伙拷锟斤拷锟铰撅拷锟斤拷锟斤拷锟斤拷毛锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟铰ｏ拷
321 : 	 <BR><BR>
322 : 	 <dl>
323 : 	   <dt>string mem_id
324 : 	   <dd>譬锟斤拷锟铰革拷锟睫硷拷锟斤拷锟斤拷锟角★拷锟斤拷gamersDream member id
325 : 	 </dl>	 
326 : 	 <BR><BR>
327 : 
328 : 
...
345 : 	 锟斤拷锟斤拷锟斤拷穴锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷  锟狡伙拷锟街硷拷锟斤拷锟截碉拷  卅锟斤拷匹  锟斤拷锟狡伙拷锟斤拷锟斤拷锟斤拷
346 : 	 <dl>
347 : 	   <dt>string result
348 : 	   <dD>successful 锟斤拷failed	   
349 : 	   <dt>string table
350 : 	   <dD>
351 : 	   <dt>int msgid
352 : 	   <dD>
...
370 : 	   侬  锟睫硷拷锟斤拷锟斤拷锟斤拷锟斤拷锟街硷拷锟斤拷锟斤拷
371 : 	 <dl>
...
436 : 	 DBUpdateEntry锟斤拷锟斤拷锟斤拷锟斤拷
437 : 	 <dl>
438 : 	   <dt>string result
439 : 	   <dd>succesful/failed
440 : 	   <dt>string table
441 : 	   <dd>  锟斤拷皮锟斤拷  毛锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
442 : 	   <dt>string key
443 : 	   <dd>平锟斤拷毛锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷		   
444 : 	   <dt>int msgid, int msgid2
445 : 	   <dd>msgid 毛锟斤拷锟斤拷锟斤拷锟斤拷忒锟绞ｏ拷
446 : 	 </dl>
447 : 	 <BR><BR>
448 : 
*/
...
468 : 	   <dt>int rank
469 : 	   <dd>锟斤拷锟剿ｏ拷1锟斤拷锟斤拷锟斤拷锟斤拷毛锟斤拷锟铰ｏ拷
470 : 	   <dt>int count
471 : 	   <dd>锟斤拷锟斤拷锟斤拷锟斤拷锟绞癸拷锟斤拷锟斤拷锟斤拷  锟劫硷拷锟睫硷拷锟斤拷锟斤拷锟斤拷0锟斤拷锟秸凤拷元锟斤拷锟铰ｏ拷
472 : 	   <dt>string table
473 : 	   <dd>  锟斤拷皮锟斤拷  毛锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
474 : 	   <dt>string key
475 : 	   <dd>平锟斤拷毛锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
476 : 	   <dt>int msgid, int msgid2
477 : 	   <dd>msgid 毛锟斤拷锟斤拷锟斤拷锟斤拷忒锟斤拷
478 : 	 </dl>
479 : 	 <BR><BR>
480 : 
481 : 	 
...
499 : 	   <dt>string table
500 : 	   <dd>  锟斤拷皮锟斤拷  毛锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
501 : 	   <dt>string key
502 : 	   <dd>平锟斤拷毛锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
503 : 	   <dt>int msgid, int msgid2
504 : 	   <dd>msgid 毛锟斤拷锟斤拷锟斤拷锟斤拷忒锟斤拷
505 : 	 </dl>
506 : 	 <BR><BR>
507 : 
*/
...
521 : 	 锟睫硷拷锟斤拷锟斤拷锟斤拷锟斤拷毛锟斤拷锟斤拷锟斤拷
522 : 	 <dl>
523 : 	   <dt>string result
524 : 	   <dd>successful/failed
525 : 	   <dt>int value
526 : 	   <dd>锟斤拷锟斤拷锟斤拷锟街硷拷
527 : 	   <dt>string table
528 : 	   <dd>  锟斤拷皮锟斤拷  毛锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
529 : 	   <dt>string key
530 : 	   <dd>平锟斤拷毛锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
531 : 	   <dt>int msgid, int msgid2
532 : 	   <dd>msgid 毛锟斤拷锟斤拷锟斤拷锟斤拷忒锟斤拷
533 : 	 </dl>
534 : 
535 : 
536 : 
...
553 : 	 DBGetEntryByRank锟斤拷锟斤拷锟斤拷锟斤拷
554 : 	 <dl>
555 : 	   <dt>string result
556 : 	   <dd>
557 : 	   <dt>string list
558 : 	   <dd>"RANK,KEY,SCORE,INFO|RANK,KEY,SCORE,INFO|...."<BR>
559 : 		   RANK锟斤拷锟斤拷锟斤拷匹丐锟铰ｏ拷KEY锟斤拷锟斤拷锟斤拷锟斤拷锟剿憋拷卅锟饺伙拷锟斤拷锟铰碉拷锟斤拷失毛锟斤拷锟饺伙拷锟斤拷锟斤拷
560 : 		   平锟斤拷锟斤拷SCORE锟斤拷锟斤拷锟窖帮拷匹锟斤拷锟斤拷失匹丐锟铰ｏ拷
561 : 		     锟斤拷<br>
562 : 		   "1,RINGO,123465,data1|2,HOGE,4567,data2|2,FUCK,4567,data3"<BR>
563 : 		   锟斤拷  锟斤拷锟斤拷锟�2锟剿凤拷2锟斤拷锟斤拷锟铰筹拷锟斤拷锟截︼拷拢锟�
564 : 	   <dt>string table
565 : 	   <dd>  锟斤拷皮锟斤拷  
...
584 : 	 DBGetEntryByCount 锟斤拷锟斤拷锟斤拷锟斤拷
585 : 	 <dl>
586 : 	   <dt>string result
587 : 	   <dd>SUCCESSFUL/FAILED
588 : 	   <dt>string list
589 : 	   <dd>锟斤拷  锟斤拷锟斤拷锟斤拷锟斤拷1锟睫硷拷锟斤拷锟斤拷丐锟斤拷曰 "INDEX,RANK,KEY,SCORE,INFO" 锟斤拷4锟桔硷拷锟斤拷  
590 : 		   锟斤拷赚匹丐曰锟斤拷锟斤拷木锟斤拷锟斤拷锟斤拷锟斤拷 "|" 匹锟斤拷卅锟斤拷锟铰ｏ拷锟斤拷锟窖伙拷0锟斤拷锟斤拷锟斤拷锟斤拷
591 : 		   锟斤拷  侬  锟斤拷
592 : 	   <dt>int num
593 : 	   <dd>锟斤拷锟绞癸拷锟斤拷曰锟斤拷锟绞撅拷锟斤拷1卅锟斤拷1锟桔ｏ拷2卅锟斤拷2锟桔ｏ拷
594 : 	   <dt>int msgid ,msgid2
595 : 	   <dd>锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷ID.	   
596 : 	 </dL>
597 : 
*/
...
612 : 	 Broadcast锟斤拷失锟斤拷锟斤拷锟斤拷锟斤拷锟接★拷锟斤拷锟斤拷锟斤拷毡亍锟截╋拷印锟斤拷锟斤拷锟竭硷拷霜锟斤拷锟斤拷
613 : 	 <dl>
614 : 	   <dt>string id
615 : 	   <dd>user ID
...
619 : 	   <dd>锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
620 : 	   <dt>int flag
621 : 	   <dd>1锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷斜锟藉反  霜锟斤拷木卅锟叫ｏ拷
622 : 	 </dl>
623 : 
*/
...
643 : 	 失锟斤拷锟斤拷锟斤拷锟斤拷锟接★拷锟斤拷锟斤拷锟斤拷毡亍锟截╋拷印锟斤拷锟斤拷锟藉丢锟斤拷锟斤拷锟斤拷锟斤拷毛霜锟斤拷锟斤拷锟铰ｏ拷
644 : 	 <dl>
...
654 : 	   <dd>锟斤拷锟斤拷锟斤拷锟斤拷锟解及    
655 : 	   <dt>int option
656 : 	   <dd>锟斤拷锟斤拷锟斤拷锟斤拷锟�(锟斤拷锟斤拷锟斤拷锟斤拷毛锟斤拷锟�)
657 : 	   <dt>int mesgid
658 : 	   <dd>锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷ID 失锟斤拷锟斤拷锟斤拷锟斤拷锟接★拷锟斤拷锟斤拷锟斤拷锟�  锟斤拷
659 : 	 </dl>
660 : 
*/
...
#ifdef _AC_SEND_FM_PK		 // WON ADD 庄园锟斤拷战锟叫憋拷锟斤拷锟斤拷锟斤拷AC
